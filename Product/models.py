...
class Product(models.Model):
    ...
    additional_image_1 = models.ImageField(upload_to="product_images")
    additional_image_2 = models.ImageField(upload_to="product_images")
    additional_image_3 = models.ImageField(upload_to="product_images")
